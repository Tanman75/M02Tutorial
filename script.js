...
<body>
 <nav class = "navbar navbar-expand-lg bg-dark navbar-dark">
      ...
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-between">
          <div>
            ...
            <p class="lead my-4">We focus on teaching our students the fundamentals of the latestand greatest technologies to prepare them for their first dev role</p>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/tsparticles-plugin-emitters/2.9.3/tsparticles.plugin.emitters.min.js"></script>
